...
CREATE TABLE IF NOT EXISTS `pages_blocks` (
 ...
 `image_file` varchar(255) COMMENT 'if this block is a image this field should contain the name of the image file.',
 `image_position` enum('left', 'center', 'right') NOT NULL default 'left' COMMENT 'if this block is a image this field should contain the position of the image.',
